...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="../../../generalao/css/vendor.css">
    <link rel="stylesheet" href="../../../generalao/css/styles.css">

    <!-- favicons
    ================================================== -->
    <link rel="apple-touch-icon" sizes="180x180" href="apple-touch-icon.png">
    <link rel="icon" type="../../../generalao/image/png" sizes="32x32" href="../../../generalao/LOGO.png">
    <link rel="icon" type="../../../generalao/image/png" sizes="16x16" href="../../../generalao/LOGO.png">
...
<body id="top">
                ...
                <div class="s-header__block">
                    <div class="header-logo">
                        <a class="logo" href="{{ route('home') }}">
                            <img src="../../../generalao/images/logo.svg" alt="Homepage">
                        </a>
                    </div>
        ...
        <section id="intro" class="container s-intro target-section">
            ...
            <div class="grid-block s-intro__content">
                ...
                <figure class="intro-pic-primary">
                    <img src="../../../generalao/images/intro-pic-primary.jpg" 
                         srcset="../../../generalao/images/intro-pic-primary.jpg 1x, 
                         ../../../generalao/images/intro-pic-primary@2x.jpg 2x" alt="">  
                </figure> <!-- end intro-pic-primary -->    
                    
                <div class="intro-block-content">

                    <figure class="intro-block-content__pic">
                        <img src="../../../generalao/images/intro-pic-secondary.jpg" 
                             srcset="../../../generalao/images/intro-pic-secondary.jpg 1x, 
                             ../../../generalao/images/intro-pic-secondary@2x.jpg 2x" alt=""> 
            ...
            <div class="row s-about__content">
                ...
                <div class="column xl-4 lg-5 md-12 s-about__content-start">
                    ...
                    <figure class="about-pic-primary">
                        <img src="../../../generalao/images/PIC.jpg" 
                             srcset="../../../generalao/images/PIC.jpg 1x, 
                             ../../../generalao/images/PIC.jpg 2x" alt=""> 
                    </figure>
                ...
                <div class="column xl-6 lg-6 md-12 s-about__content-end"> 
                    ...
                    <p>
                    In the quiet town of San Vicente, nestled between misty hills and mango trees, there was a tiny café called Luna Brew. It wasn’t fancy—just four wooden tables, a cracked chalkboard menu, and the rich smell of roasted beans that floated out onto the street like a warm hug.
                    </p>
                    <p>
                    The café was owned by an old man named Lolo Ben. He had been making coffee for over forty years, ever since his wife passed and left him their old Moka pot and a note that said, “Keep brewing, even on the coldest days.”
                    </p>
                    <p>
                    People didn’t just come for the coffee—they came for him. He knew exactly how you liked it. Sweet for the students, bold for the tricycle drivers, creamy for the teachers. And he always had a story to share—about love, loss, and the smell of morning rain.
                    </p>
                    <p>
                    But Lolo Ben was growing tired. His hands trembled. The shop was getting quieter. One rainy morning, he flipped the sign to “Closed” and whispered, “Just one last cup.”
                    </p>
                    <p>
                    He brewed it carefully, like it was a ritual. He poured the dark, steaming drink into his favorite chipped mug, the one with a faded sunflower design. Then, he sat by the window and looked out at the empty street.
                    </p>
                    <p>
                    Just as he raised the cup, the door creaked open.
                    </p>
                    <p>
                    A young woman, soaked from the rain, stepped inside. She looked around, confused. “Sorry,” she said. “I thought you were open.”
                    </p>
                    <p>
                    Lolo Ben smiled. “I guess… I have one more cup to share.”
                    </p>
                    <p>
                    They sat together, sipping in silence. She told him she had just moved to town, chasing a dream to write. He told her about his late wife, and the promise he made.
                    </p>
                    <p>
                    When she stood to leave, she asked, “Will you open again tomorrow?”
                    </p>
                    <p>
                    Lolo Ben paused, then chuckled. “Maybe. If I dream of coffee tonight.”
                    </p>
                    <p>
                    The next morning, the chalkboard outside Luna Brew had a new message:
                    </p>
                    <p>
                    "Still brewing, still dreaming. Come in for your story in a cup."
                    </p>
        ...
        <section id="gallery" class="container s-gallery target-section">
            ...
            <div class="gallery-items grid-cols grid-cols--wrap">
                ...
                <div class="gallery-items__item grid-cols__column">
                    <a href="../../../generalao/images/gallery/large/l-gallery-01.jpg" class="gallery-items__item-thumb glightbox">
                        <img src="../../../generalao/images/gallery/gallery-01.jpg" 
                            srcset="../../../generalao/images/gallery/gallery-01.jpg 1x, 
                                    ../../../generalao/images/gallery/gallery-01@2x.jpg 2x" alt="">                                
                    </a>
                </div> <!-- end gallery-items__item-->
    
                <div class="gallery-items__item grid-cols__column">
                    <a href="../../../generalao/images/gallery/large/l-gallery-02.jpg" class="gallery-items__item-thumb glightbox">
                        <img src="../../../generalao/images/gallery/gallery-02.jpg" 
                            srcset="../../../generalao/images/gallery/gallery-02.jpg 1x, 
                                    ../../../generalao/images/gallery/gallery-02@2x.jpg 2x" alt="">
                    </a>
                </div> <!-- end gallery-items__item -->
    
                <div class="gallery-items__item grid-cols__column">
                    <a href="../../../generalao/images/gallery/large/l-gallery-03.jpg" class="gallery-items__item-thumb glightbox">
                        <img src="../../../generalao/images/gallery/gallery-03.jpg" 
                            srcset="../../../generalao/images/gallery/gallery-03.jpg 1x, 
                                    ../../../generalao/images/gallery/gallery-03@2x.jpg 2x" alt="">
                    </a>
                </div> <!-- end gallery-items__item -->
    
                <div class="gallery-items__item grid-cols__column">
                    <a href="../../../generalao/images/gallery/large/l-gallery-04.jpg" class="gallery-items__item-thumb glightbox">
                        <img src="../../../generalao/images/gallery/gallery-04.jpg" 
                            srcset="../../../generalao/images/gallery/gallery-04.jpg 1x, 
                                    ../../../generalao/images/gallery/gallery-04@2x.jpg 2x" alt="">
                    </a>
                </div> <!-- end gallery-items__item -->
    
                <div class="gallery-items__item grid-cols__column">
                    <a href="../../../generalao/images/gallery/large/l-gallery-05.jpg" class="gallery-items__item-thumb glightbox">
                        <img src="../../../generalao/images/gallery/gallery-05.jpg" 
                            srcset="../../../generalao/images/gallery/gallery-05.jpg 1x, 
                                    ../../../generalao/images/gallery/gallery-05@2x.jpg 2x" alt="">
                    </a>
                </div> <!-- end gallery-items__item -->
    
                <div class="gallery-items__item grid-cols__column">
                    <a href="../../../generalao/images/gallery/large/l-gallery-06.jpg" class="gallery-items__item-thumb glightbox">
                        <img src="../../../generalao/images/gallery/gallery-06.jpg" 
                            srcset="../../../generalao/images/gallery/gallery-06.jpg 1x, 
                                    ../../../generalao/images/gallery/gallery-06@2x.jpg 2x" alt="">
                    </a>
                </div> <!-- end gallery-items__item -->
    
                <div class="gallery-items__item grid-cols__column">
                    <a href="../../../generalao/images/gallery/large/l-gallery-07.jpg" class="gallery-items__item-thumb glightbox">
                        <img src="../../../generalao/images/gallery/gallery-07.jpg" 
                            srcset="../../../generalao/images/gallery/gallery-07.jpg 1x, 
                                    ../../../generalao/images/gallery/gallery-07@2x.jpg 2x" alt="">
                    </a>
                </div> <!-- end gallery-items__item -->
    
                <div class="gallery-items__item grid-cols__column">
                    <a href="../../../generalao/images/gallery/large/l-gallery-08.jpg" class="gallery-items__item-thumb glightbox">
                        <img src="../../../generalao/images/gallery/gallery-08.jpg" 
                            srcset="../../../generalao/images/gallery/gallery-08.jpg 1x, 
                                    ../../../generalao/images/gallery/gallery-08@2x.jpg 2x" alt="">
                    </a>
                </div> <!-- end gallery-items__item -->
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="testimonials-slider__slide swiper-slide">
                                <div class="testimonials-slider__author">
                                    <img src="../../../generalao/images/avatars/NIG.png" alt="Author image" class="testimonials-slider__avatar">
                                ...
                                <p>
                                “The best coffee in town—smooth, rich, and brewed with heart. You can really taste the love in every cup.”
                                </p>
                            </div> <!-- end testimonials-slider__slide -->
            
                            <div class="testimonials-slider__slide swiper-slide">
                                <div class="testimonials-slider__author">
                                    <img src="../../../generalao/images/avatars/GA.png" alt="Author image" class="testimonials-slider__avatar">
                                    <cite class="testimonials-slider__cite">
                                        Charles Dera
                                        <span>BU, RAT</span>
                                    </cite>
                                ...
                                <p>
                                “A perfect balance of bitterness and sweetness. Their caramel macchiato symphony is a game-changer!”
                            ...
                            <div class="testimonials-slider__slide swiper-slide">
                                <div class="testimonials-slider__author">
                                    <img src="../../../generalao/images/avatars/OP.png" alt="Author image" class="testimonials-slider__avatar">
                                    <cite class="testimonials-slider__cite">
                                        Jordi ENP
                                        <span>FUKIKO</span>
                                    </cite>
                                ...
                                <p>
                                “The aroma alone is enough to make you smile. One sip, and you’ll feel like you’re home.”
                                </p>
                            </div> <!-- end testimonials-slider__slide -->
    
                            <div class="testimonials-slider__slide swiper-slide">
                                <div class="testimonials-slider__author">
                                    <img src="../../../generalao/images/avatars/RED.png" alt="Author image" class="testimonials-slider__avatar">
                                    <cite class="testimonials-slider__cite">
                                        J Mac
                                        <span>JAJA, COLLEN</span>
                                    </cite>
                                </div>
                                <p>
                                “Nice and strong, just how I like it! Maybe a little too bold for some, but it definitely wakes you up.”
                                </p>
                            </div> <!-- end testimonials-slider__slide -->
            ...
            <div class="row s-footer__main">             
                ...
                <div class="column xl-9 lg-12 s-footer__main-end grid-cols grid-cols--wrap">
                    ...
                    <div class="grid-cols__column footer-block">     
                        <h6>Contacts</h6>
                        <ul class="link-list">
                            <li><a href="mailto:#0">contact@thelastcup.com</a></li>
    ...
    <!-- Java Script
    ================================================== -->
    <script src="../../../generalao/js/plugins.js"></script>
    <script src="../../../generalao/js/main.js"></script>
